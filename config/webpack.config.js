...
const ReplaceCodePlugin = require('./webpack/replaceCode');
const IncrementalChunkFilenamePlugin = require('./webpack/incrementalFileNamePlugin')
        ...
        cacheGroups: {
          widgets: {
            ...
            name: (module, chunks, cacheGroupKey) => {
              const folderName = module.context.split(path.sep).pop();
